...
def vis_keypoints(img, kps, score, skeleton,  score_thr=float(0.4), line_width=3, circle_rad = 3,filename=None):
    ...
    for i in range(len(skeleton)):
        ...
        if score[i] > 0 and score[pid] > 0 and pid != -1:
    ...
    #cv2.imshow('hand_pose',_img)

    # if save_path is None:
    # else:
    cv2.imwrite('/root/Workspace/jyk/skeleton/output/result/'+ filename,img_)



def vis_3d_keypoints(kps_3d, score, skeleton, filename=None, score_thr=0.4, line_width=3, circle_rad=3):
